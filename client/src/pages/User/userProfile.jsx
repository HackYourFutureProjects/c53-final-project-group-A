    ...
    <>
        ...
        <nav className="max-w-7xl mx-auto px-6 py-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-xl text-gray-700">JobFinder</div>
            </div>
      ...
      <main className="flex-grow max-w-3xl mx-auto px-6 py-12 w-full">
          ...
          <div className="border border-gray-300 rounded p-4">
            <div className="grid grid-cols-2 gap-x-8 gap-y-2">
              <label className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-700">Groningen</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm text-gray-700">Friesland</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm text-gray-700">Drenthe</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm text-gray-700">Overijssel</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" checked className="form-checkbox" />
                <span className="text-sm text-gray-700">Flevoland</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm text-gray-700">Gelderland</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" checked className="form-checkbox" />
                <span className="text-sm text-gray-700">Utrecht</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" checked className="form-checkbox" />
                <span className="text-sm text-gray-700">Noord-Holland</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" checked className="form-checkbox" />
                <span className="text-sm text-gray-700">Zuid-Holland</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm text-gray-700">Zeeland</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm text-gray-700">Noord-Brabant</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm text-gray-700">Limburg</span>
              </label>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            />
            <span className="text-gray-700">hh :</span>
            <input
              type="text"
              value="30"
              className="w-16 px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 text-center"
      ...
      <footer className="bg-gray-200 py-8 mt-12">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p className="text-xl text-gray-700">Footer</p>
        </div>
      </footer>
    </>
  );
